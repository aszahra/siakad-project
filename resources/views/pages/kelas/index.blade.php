                        ...
                        <div>
                            <form action="{{route('kelas.store') }}" method="post">
                                ...
                                <div class="my-5">
                                    ...
                                    <input type="text" id="kode_kelas" name="kode_kelas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan kode kelas disini.." value="{{$kode_kelas}}" readonly required />
                                </div>
                                <div class="mb-5">
                                    <label for="jurusan"
            ...
            <div class="w-full md:w-1/2 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="mb-5">
                            <label for="kode_kelas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Kelas
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="kd_kelas" name="kode_kelas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan kelasan...." readonly />
                            <span class="text-sm m-l text-red-500">{{ $errors->first('room') }}</span>
                        </div>
                        <div class="mb-5">
                            <label for="kelas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">kelas
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="nm_kelas" name="kelas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan kelasan...." />
                            <span class="text-sm m-l text-red-500">{{ $errors->first('room') }}</span>
                        </div>
                    </div>
