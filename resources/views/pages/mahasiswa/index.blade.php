<x-app-layout>
            ...
            <div class="w-full md:w-1/2 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="mb-5">
                            <label for="nim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Kelas
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="kd_kelas" name="nim" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan kelasan...." readonly />
    ...
    <script>
                    ...
                    render: (data, type, row) => {
                        let editUrl =
                            `<button type="button" data-id="${data.id}"
                                                        data-modal-target="sourceModal" data-nim="${data.nim}" data-kelas="${data.kelas}"
        ...
        const editSourceModal = (button) => {
            ...
            document.getElementById('kd_kelas').value = nim;
